...
1) A two digit 7-segment display controled by an =SDA2131= display driver. Found already wired together on a pcb board  in an old pc.

#+CAPTION: SDA2131 pinout
#+ATTR_ORG: :width 200
[[./images/sevendht-sda2131-pinout.png]]

#+CAPTION: pinout of the cable that comes out of the board
|----+-----+------+-----+-----+---+---|
