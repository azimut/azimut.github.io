#+TITLE: Factor: server programming challenges
#+DATE: <2025-11-16 dom>
#+DESCRIPTION: My first take trying to solve server programming challenges in Factor.
#+KEYWORDS: protohackers, nping, protohackers.com, factor, factorlang, network programming, netcat, socat

I have been gawking at the networking programming challenges of [[https://protohackers.com/][protohackers]] for a while. At first I wanted to solve them using [[https://www.gnu.org/software/gawk/manual/gawkinet/html_node/Gawk-Special-Files.html][AWK]] but I never go around to it, and moved on to learn other programming languages.

Last week I have been learning a bit of [[https://factorcode.org/][Factor]]. First programming language of the [[https://en.wikipedia.org/wiki/Concatenative_programming_language][concatenative]] family of programming languages that I try.

Among other things I wanted to try it because it seemed to have a very rich [[https://docs.factorcode.org/content/article-vocab-index.html][stdlib]].

You can find my solutions [[https://github.com/azimut/challenges/tree/master/protohackers][here]].
...
- with no data received, it should immediately close connection.
...
A TCP based chatroom. With nicks, and message status on join/leave.
...
In order to deploy my server to be checked externally by protohackers I set it up using [[https://pinggy.io/][pinggy.io]].
